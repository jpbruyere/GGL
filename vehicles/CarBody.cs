...
namespace JitterExtensions
{
    ...
    /// </summary>
    public class CarBody : RigidBody
    {
        ...
        private const float springFrac = 0.3f;
        ...
        public CarBody(World world,Shape shape) : base(shape)
        {
            this.world = world;
            ...
            this.SteerRate = 5.0f;
            this.Mass = 10f;
            //this.EnableSpeculativeContacts = true;

            // create default wheels
            wheels[(int)WheelPosition.FrontLeft] = new Wheel(world, this, 1.3f*JVector.Left + 1.8f * JVector.Down + 1.2f * JVector.Forward, 0.8f);
            wheels[(int)WheelPosition.FrontRight] = new Wheel(world, this, 1.3f * JVector.Right + 1.8f * JVector.Down + 1.2f * JVector.Forward, 0.8f);
            wheels[(int)WheelPosition.BackLeft] = new Wheel(world, this, 1.3f * JVector.Left + 1.8f * JVector.Up + 1.2f * JVector.Forward, 0.8f);
            wheels[(int)WheelPosition.BackRight] = new Wheel(world, this, 1.3f * JVector.Right + 1.8f * JVector.Up + 1.2f * JVector.Forward, 0.8f);
